...
const EndsInCounter = (props) => {
    ...
    useEffect(() => {
        ...
        if (auction && auction.end_time && (moment().diff(auction.end_time) < -1000)) {
            if (timerObj.timer) {
...
export default withRouter(connect(stateToProps, actionToProps)(EndsInCounter));
