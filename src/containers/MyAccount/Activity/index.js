...
const stateToProps = (state) => {
    return {
        ...
        skip: state.activity.userActivity.skip,
        limit: state.activity.userActivity.limit,
        inProgress: state.activity.userActivity.inProgress,
        total: state.activity.userActivity.total,
...
export default withRouter(connect(stateToProps, actionToProps)(Activity));
