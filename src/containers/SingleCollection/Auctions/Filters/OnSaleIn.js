...
import { setCAOnSaleIn, setCAOnSaleInSearch, setCAPriceRange } from '../../../../actions/auctions/filters';
...
const OnSaleIn = (props) => {
    ...
    const handleSelect = (event, value) => {
        ...
        props.fetchCollectionAuctions(route, props.listedNFTsSkip, props.listedNFTsLimit, [...list], null, null,
            props.auctionsTypeCA, props.address, props.sortBy, props.order, props.listedSearch);
        if (props.search !== '') {
            props.onSearch('');
...
const stateToProps = (state) => {
    return {
        ...
        lang: state.language,
        list: state.auctions.filters.onSaleInCA.list,
        search: state.auctions.filters.onSaleInCA.search,
        value: state.auctions.filters.onSaleInCA.value,
...
const actionToProps = {
    onChange: setCAOnSaleIn,
    onSearch: setCAOnSaleInSearch,
